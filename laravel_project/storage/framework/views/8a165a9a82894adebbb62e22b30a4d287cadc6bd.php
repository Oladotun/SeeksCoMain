...
<?php $__env->startSection('content'); ?>
    ...
    <div class="filter nice-scroll">
        <form method="GET" action="<?php echo e(route('page.category.state.city', ['category_slug' => $category->category_slug, 'state_slug' => $state->state_slug, 'city_slug' => $city->city_slug])); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="filter__btns">
                ...
                <a class="btn btn-outline-secondary filter__reset__btn" href="<?php echo e(route('page.category.state.city', ['category_slug' => $category->category_slug, 'state_slug' => $state->state_slug, 'city_slug' => $city->city_slug])); ?>"><?php echo e(__('theme_directory_hub.filter-link-reset-all')); ?></a>
            </div>
        </form>
        <hr>
    ...
    <section class="listing nice-scroll">
                ...
                <?php $__currentLoopData = $children_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $children_categories_key => $children_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-12 col-md-6 col-lg-3 pr-0">
                        <div class="categories__item categories__item_sm">
                            <a href="<?php echo e(route('page.category.state', ['category_slug' => $children_category->category_slug, 'state_slug' => $state->state_slug])); ?>">
        ...
        <div class="listing__text__top">
            <div class="listing__text__top__left">
                <h5><?php echo e(__('frontend.category.city.sub-title-1', ['category_name' => $category->category_name, 'city_name' => $city->city_name, 'state_name' => $state->state_name])); ?></h5>
                <span><?php echo e($total_results); ?> <?php echo e(__('theme_directory_hub.filter-results')); ?></span>
            </div>
        ...
        <?php if($all_item_cities->count() > 0): ?>
            <div class="listing__text__top">
                <div class="listing__text__top__left">
                    <h5><?php echo e(__('frontend.category.state.sub-title-2', ['category_name' => $category->category_name, 'state_name' => $state->state_name])); ?></h5>
                </div>
            </div>
...
<?php echo $__env->make('frontend_views.lduruo10_dh_frontend_city_path.layouts.app-full-width', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/seekscodirectory/laravel_project/theme_views/frontend_views/lduruo10_dh_frontend_city_path/category/city.blade.php ENDPATH**/ ?>