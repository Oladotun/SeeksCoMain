...
<?php $__env->startSection('content'); ?>
    ...
    <div class="filter nice-scroll">
        ...
        <div class="filter__location">
            <input type="text" id="search_query" name="search_query" value="<?php echo e($search_query); ?>" placeholder="<?php echo e(__('frontend.search.what-are-you-looking-for')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="filter__btns">
            ...
            <a class="btn btn-outline-secondary filter__reset__btn" href="<?php echo e(route('page.search')); ?>"><?php echo e(__('theme_directory_hub.filter-link-reset-all')); ?></a>
        </div>
        </form>
        <hr>
    ...
    <section class="listing nice-scroll">
        ...
        <div class="listing__text__top">
            <div class="listing__text__top__left">
                <h5><?php echo e(__('frontend.search.sub-title-1')); ?></h5>
...
<?php echo $__env->make('frontend_views.lduruo10_dh_frontend_city_path.layouts.app-full-width', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/seekscodirectory/laravel_project/theme_views/frontend_views/lduruo10_dh_frontend_city_path/search.blade.php ENDPATH**/ ?>