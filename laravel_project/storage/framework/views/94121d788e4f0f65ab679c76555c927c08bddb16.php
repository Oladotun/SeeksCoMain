...
unset($__errorArgs, $__bag); ?>" name="user_prefer_language">
                                    ...
                                    <?php $__currentLoopData = \App\Setting::LANGUAGES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting_languages_key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($language); ?>" <?php echo e((old('user_prefer_language') ? old('user_prefer_language') : $user->user_prefer_language) == $language ? 'selected' : ''); ?>>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/seekscodirectory/laravel_project/resources/views/backend/admin/user/edit.blade.php ENDPATH**/ ?>