                    ...
                    <!-- <li class="nav-item"> -->
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <div>
                                ...
                                <div>
                                <li class="nav-item"><a  href="<?php echo e(route('login')); ?>"><?php echo e(__('frontend.header.login')); ?></a>
                                     <strong class="border-left" style="border-left: 3px; padding-right: 5px;"> </strong>
                                <?php if(Route::has('register')): ?>
                                    <a  href="<?php echo e(route('register')); ?>"><?php echo e(__('frontend.header.register')); ?></a>
                                <?php endif; ?>
                                </li>
                            </div>
