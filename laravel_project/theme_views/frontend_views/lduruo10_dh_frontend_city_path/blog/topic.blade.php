            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2 style="color: {{ $site_innerpage_header_title_font_color }};">{{ trans_choice('frontend.blog.topic', 0) }}: {{ $topic->name }}</h2>
                        <p style="color: {{ $site_innerpage_header_paragraph_font_color }};">{{ __('frontend.blog.topic-description', ['topic_name' => $topic->name]) }}</p>
                    </div>
                </div>
            </div>
        </div>
