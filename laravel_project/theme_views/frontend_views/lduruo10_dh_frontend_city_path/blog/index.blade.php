            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2 style="color: {{ $site_innerpage_header_title_font_color }};">{{ __('frontend.blog.title') }}</h2>
                        <p style="color: {{ $site_innerpage_header_paragraph_font_color }};">{{ __('frontend.blog.description') }}</p>
                    </div>
                </div>
            </div>
        </div>
