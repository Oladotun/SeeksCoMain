            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2 style="color: {{ $site_innerpage_header_title_font_color }};">{{ __('auth.login') }}</h2>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-6">
                    <div class="alert alert-info alert-dismissible" role="alert">
                        <span>{{ __('demo_login.demo-login-credentials') }}</span>
                        <hr>

                        <div class="row">
                            <div class="col-2"><u><span>{{ __('demo_login.admin-account') }}</span></u></div>
                            <div class="col-7 text-right">
                                <span>
                                    {{ \App\Setting::DEMO_ADMIN_LOGIN_EMAIL . " / " . \App\Setting::DEMO_ADMIN_LOGIN_PASSWORD }}
                                </span>
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-2"><u><span>{{ __('demo_login.user-account') }}</span></u></div>
                            <div class="col-7 text-right">
                                <span>
                                    {{ \App\Setting::DEMO_USER_LOGIN_EMAIL . " / " . \App\Setting::DEMO_USER_LOGIN_PASSWORD }}
                                </span>
                            </div>
                            <div class="col-3 text-right">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-6">
                    <form method="POST" action="{{ route('login') }}" class="p-5 bg-white">
                        ...
                        @enderror
                        <input id="password" type="password" class="@error('password') is-invalid @enderror" name="password" placeholder="{{ __('auth.password') }}" required autocomplete="current-password">
                        @error('password')
                        <span class="invalid-tooltip" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
