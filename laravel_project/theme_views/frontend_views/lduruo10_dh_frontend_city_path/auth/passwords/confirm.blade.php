            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2 style="color: {{ $site_innerpage_header_title_font_color }};">{{ __('auth.confirm-password') }}</h2>
                        <p style="color: {{ $site_innerpage_header_paragraph_font_color }};">{{ __('auth.confirm-password-message') }}</p>
                    </div>
                </div>
            </div>
        </div>
