...
@section('content')
    ...
    <div class="filter nice-scroll">
        <form method="GET" action="{{ route('page.category.state', ['category_slug' => $category->category_slug, 'state_slug' => $state->state_slug]) }}">
            ...
            <div class="filter__btns">
                ...
                <a class="btn btn-outline-secondary filter__reset__btn" href="{{ route('page.category.state', ['category_slug' => $category->category_slug, 'state_slug' => $state->state_slug]) }}">{{ __('theme_directory_hub.filter-link-reset-all') }}</a>
            </div>
        </form>
        <hr>
    ...
    <section class="listing nice-scroll">
        ...
        <div class="listing__text__top">
            <div class="listing__text__top__left">
                <h5>{{ __('frontend.category.state.sub-title-1', ['category_name' => $category->category_name, 'state_name' =>  $state->state_name]) }}</h5>
