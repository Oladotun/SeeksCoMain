<div class="filter nice-scroll  col-12"  style="background-color:#b6d5f6; overflow-y: scroll;">
            <form method="GET" action="{{ route('page.categories') }}">
                ...
                <div class="filter__select">
                    <select class="custom-select mb-3 @error('filter_city') is-invalid @enderror" name="filter_city" id="filter_city" data-live-search="true">
                ...
                <div class="filter__tags">
                    ...
                    <select class="custom-select @error('filter_categories') is-invalid @enderror"  data-live-search="true" name="filter_categories[]" id="filter_categories" multiple>
